...
module distortion (
    ...
    always @(*) begin
        ...
        // CLEAN: true bypass (no trim/no gate/no nonlinearity).
        if (mode == 2'b00) begin
            out_sample = in_sample;
        end else begin
            // Keep only a very light gate in distortion modes to reduce idle hiss
            // without choking normal playing dynamics.
            case (mode)
                2'b01: gate_thr = 32'd32;
                2'b10: gate_thr = 32'd48;
                default: gate_thr = 32'd64;
            endcase
