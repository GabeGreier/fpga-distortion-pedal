...
module wm8731_config(
    ...
    initial begin
        ...
        // Line input volumes: reduced further to avoid front-end clipping from hot modeler outputs.
        rom[2]  = {7'h00, 9'h008};   // Left Line In
        rom[3]  = {7'h01, 9'h008};   // Right Line In
        ...
        // I2S, 16-bit, codec in master mode (BCLK/LRCLK generated by WM8731)
        // DE2-115 routes AUD_BCLK/AUD_ADCLRCK from codec to FPGA as inputs.
        rom[8]  = {7'h07, 9'h042};
